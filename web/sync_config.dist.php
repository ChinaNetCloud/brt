<?php
/* Database configs */
$database_sugar_host = "127.0.0.1";
$database_sugar_port = "";
$database_sugar_name_db = "sugarcrm_db";
$database_sugar_user = "user_sugar";
$database_sugar_password = "password";

/* Database configs */
$database_zabbix_host = "127.0.0.1";
$database_zabbix_port = "";
